...
var Ad=t;function Bd(a){return a?new Dd(Ed(a)):qa||(qa=new Dd)}
...
var re,se=new he;re=se.isAvailable()?new oe(se):null;var qe,ue=new ie;qe=ue.isAvailable()?new oe(ue):null;var ve=B("Firefox"),we=nc()||B("iPod"),xe=B("iPad"),ye=B("Android")&&!(Va()||B("Firefox")||B("Opera")||B("Silk")),ze=Va(),Ae=B("Safari")&&!(Va()||B("Coast")||B("Opera")||B("Edge")||B("Silk")||B("Android"))&&!(nc()||B("iPad")||B("iPod"));function Be(a,b,c){this.b=a;this.g=b;this.f=c}
var Ce=1;function De(a){var b={};void 0!==a.b?b.trackingParams=a.b:(b.veType=a.g,null!=a.f&&(b.veCounter=a.f));return b}
;var Ee={log_event:"events",log_interaction:"interactions"},Fe={},Ge={},He=0,Oa=r("yt.logging.transport.logsQueue_")||{};q("yt.logging.transport.logsQueue_",Oa,void 0);function Ie(a,b){Oa[a.endpoint]=Oa[a.endpoint]||[];var c=Oa[a.endpoint];c.push(a.Na);Ge[a.endpoint]=b;c.length>=(Number(M("web_logging_max_batch")||0)||20)?Je():Ke()}
...
function Me(a,b,c){b.eventTimeMs=Math.round(Kb());b.lactMs=de();c&&(b.clientData=Pe(c));Ie({endpoint:"log_interaction",Na:b},a)}
...
cf.prototype.round=function(){this.left=Math.round(this.left);this.top=Math.round(this.top);this.width=Math.round(this.width);this.height=Math.round(this.height);return this};function df(a,b){var c=Ed(a);return c.defaultView&&c.defaultView.getComputedStyle&&(a=c.defaultView.getComputedStyle(a,null))?a[b]||a.getPropertyValue(b)||"":""}
...
y(Jf,D);function Kf(a,b,c,d){d=Hb(w(d,a.g));d={target:b,name:c,pa:d};b.addEventListener(c,d.pa,void 0);a.b.push(d)}
...
y(Uf,pa);Uf.prototype.name="cancel";function dg(){return{apiaryHost:F("APIARY_HOST",void 0),Ea:F("APIARY_HOST_FIRSTPARTY",void 0),gapiHintOverride:F("GAPI_HINT_OVERRIDE"),gapiHintParams:F("GAPI_HINT_PARAMS",void 0),innertubeApiKey:F("INNERTUBE_API_KEY",void 0),innertubeApiVersion:F("INNERTUBE_API_VERSION",void 0),tb:F("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),innertubeContextClientVersion:F("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0),vb:F("INNERTUBE_CONTEXT_HL",void 0),ub:F("INNERTUBE_CONTEXT_GL",void 0),Vb:F("XHR_APIARY_HOST",void 0)}}
function eg(a){a={client:{hl:a.vb,gl:a.ub,clientName:a.tb,clientVersion:a.innertubeContextClientVersion}};F("DELEGATED_SESSION_ID")&&(a.user={onBehalfOfUser:F("DELEGATED_SESSION_ID")});return a}
;function fg(){this.b=dg();gg||(gg=hg(this.b))}
var gg=null;function hg(a){return(new N(function(b){Xb(F("GAPI_LOADER_URL",void 0),function(){try{r("yt.gapi.load")("client",{gapiHintOverride:a.gapiHintOverride,_c:{jsl:{h:a.gapiHintParams}},callback:b})}catch(c){Jb(c)}})})).then(function(){})}
...
fg.prototype.g=function(a,b,c){var d,e=!1;0<c.timeout&&(d=G(function(){e||(e=!0,c.R&&c.R())},c.timeout));
ig(this,a,b,function(a){if(!e)if(e=!0,d&&Ib(d),a)c.F&&c.F(a);else if(c.onError)c.onError()})};
function ig(a,b,c,d){var e={path:"/youtubei/"+a.b.innertubeApiVersion+"/"+b,headers:{"X-Goog-Visitor-Id":F("VISITOR_DATA")},method:"POST",body:Hc(c)},f=w(a.i,a);gg.then(function(){f();r("gapi.client.request")(e).execute(d||t)})}
;function jg(a,b,c){var d={};d.eventTimeMs=Math.round(c||Kb());d[a]=b;Ie({endpoint:"log_event",Na:d},fg)}
...
function Cg(a){if("_"!=a[0]){var b=a;vg.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),vg.mark(b))}var b=Dg(),c=Kb();b[a]&&(b["_"+a]=b["_"+a]||[b[a]],b["_"+a].push(c));b[a]=c;Eg()["tick_"+a]=void 0;Kb();M("csi_on_gel")?(b=Fg(),"_start"==a?jg("latencyActionBaselined",{clientActionNonce:b},void 0):jg("latencyActionTicked",{tickName:a,clientActionNonce:b},void 0),a=!0):a=!1;a||(a=!!r("yt.timing.pingSent_")&&!!M("navigation_only_csi_reset"));if(!a&&(b=F("TIMING_ACTION",void 0),a=Dg(),r("yt.timing.ready_")&&
b&&a._start&&Gg())){b=!0;c=F("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}b&&Hg()}}
function Ig(){var a=Jg().info.yt_lt="hot_bg";Eg().info_yt_lt=a;if(M("csi_on_gel"))if("yt_lt"in zg){var b={},c=zg.yt_lt;Aa(Ag,c)&&(a=!!a);b[c]=a;a=Fg();b.clientActionNonce=a;jg("latencyActionInfo",b)}else Jb(Error("Unknown label yt_lt logged with GEL CSI."))}
...
k.Ub=function(){if(!this.ca){var a=Zg(this);a&&"html5"==$g(this)?(this.L="html5",this.G||this.W()):(ah(this),this.L="html5",a&&this.X?(this.w.appendChild(this.X),this.W()):(this.b.loaded=!0,this.Y=w(function(){var a=this.w,c=af(this.b);r("yt.player.Application.create")(a,c);this.W()},this),this.ca=!0,a?this.Y():(Xb(this.b.assets.js,this.Y),qf(this.b.assets.css))))}};
...
k.zb=function(){this.na||(ze?(this.la=Kd(document),Kf(this.P,window,"scroll",this.Ib),Kf(this.P,this.w,"touchmove",this.Gb)):(Kf(this.P,this.w,"mousewheel",this.Ma),Kf(this.P,this.w,"wheel",this.Ma)),this.na=!0)};
...
function ah(a){Cg("dcp");a.cancel();Qg(a);a.L=null;a.b&&(a.b.loaded=!1);var b=Yg(a);"html5"==$g(a)?a.X=b:b&&b.destroy&&b.destroy();Ld(a.w);Lf(a.da);a.J=null;a.O=null}
k.cancel=function(){this.Y&&dc(this.b.assets.js,this.Y);Ib(this.Ba);this.ca=!1};
k.A=function(){ah(this);if(this.X&&this.b)try{this.X.destroy()}catch(b){Jb(b)}this.ha=null;for(var a in this.j)n[this.j[a]]=null;this.oa=this.b=this.g=null;delete this.w;delete this.D;Pg.B.A.call(this)};var dh={},eh="player_uid_"+(1E9*Math.random()>>>0);function fh(a,b){a=v(a)?Fd(a):a;b=$e(b);var c=eh+"_"+ha(a),d=dh[c];if(d)return d.xa(b),d.g;d=new Pg(a,c);dh[c]=d;Ub("player-added",d.g);zb(d,na(gh,d));G(function(){d.xa(b)},0);
return d.g}
function gh(a){dh[a.$]=null}
function hh(a){a=Fd(a);if(!a)return null;var b=eh+"_"+ha(a),c=dh[b];c||(c=new Pg(a,b),dh[b]=c);return c.g}
;var ih=r("yt.abuse.botguardInitialized")||gc;q("yt.abuse.botguardInitialized",ih,void 0);var jh=r("yt.abuse.invokeBotguard")||hc;q("yt.abuse.invokeBotguard",jh,void 0);var kh=r("yt.abuse.dclkstatus.checkDclkStatus")||od;q("yt.abuse.dclkstatus.checkDclkStatus",kh,void 0);var lh=r("yt.player.exports.navigate")||Ve;q("yt.player.exports.navigate",lh,void 0);var mh=r("yt.player.embed")||fh;q("yt.player.embed",mh,void 0);var nh=r("yt.player.getPlayerByElement")||hh;q("yt.player.getPlayerByElement",nh,void 0);
...
G(function(){ud(d,u)},0)}}}}
function hi(a,b,c,d,e,f){var g;wd(c,U(a,"tip-reverse"),f);var l=0;f&&(l=1);a=hf(b);f=new K((a.width-10)/2,f?a.height:0);var h=Ed(b);g=new K(0,0);var m;m=h?Ed(h):document;m=!H||9<=Number(Cc)||Jd(Bd(m).b)?m.documentElement:m.body;b!=m&&(m=ff(b),h=Kd(Bd(h).b),g.l=m.left+h.l,g.o=m.top+h.o);f=new K(g.l+f.l,g.o+f.o);f=new K(f.l,f.o);g=(l&8&&"rtl"==ef(c,"direction")?l^4:l)&-9;l=hf(c);h=new pd(l.width,l.height);f=new K(f.l,f.o);h=new pd(h.width,h.height);0!=g&&(g&4?f.l-=h.width+0:g&2&&(f.l-=h.width/2),g&
1&&(f.o-=h.height+0));g=new cf(0,0,0,0);g.left=f.l;g.top=f.o;g.width=h.width;g.height=h.height;f=g;g=0;if(!(g&496||(g=f,h=new K(g.left,g.top),h instanceof K?(g=h.l,h=h.o):(g=h,h=void 0),c.style.left=gf(g,!1),c.style.top=gf(h,!1),h=new pd(f.width,f.height),l==h||l&&h&&l.width==h.width&&l.height==h.height)))if(l=h,g=Jd(Bd(Ed(c)).b),!H||I("10")||g&&I("8"))f=c.style,tc?f.MozBoxSizing="border-box":uc?f.WebkitBoxSizing="border-box":f.boxSizing="border-box",f.width=Math.max(l.width,0)+"px",f.height=Math.max(l.height,
0)+"px";else if(f=c.style,g){if(H){g=lf(c,"paddingLeft");h=lf(c,"paddingRight");m=lf(c,"paddingTop");var u=lf(c,"paddingBottom");g=new bf(m,h,u,g)}else g=df(c,"paddingLeft"),h=df(c,"paddingRight"),m=df(c,"paddingTop"),u=df(c,"paddingBottom"),g=new bf(parseFloat(m),parseFloat(h),parseFloat(u),parseFloat(g));if(!H||9<=Number(Cc))h=df(c,"borderLeftWidth"),m=df(c,"borderRightWidth"),u=df(c,"borderTopWidth"),Ba=df(c,"borderBottomWidth"),h=new bf(parseFloat(u),parseFloat(m),parseFloat(Ba),parseFloat(h));
...
Nh(a,"subscribe")}
;var ni=window.yt&&window.yt.uix&&window.yt.uix.widgets_||{};q("yt.uix.widgets_",ni,void 0);/*
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
var oi=window,pi=document,qi=oi.location;function ri(){}
...
Ei.push(["jsl",function(a){for(var b in a)if(Object.prototype.hasOwnProperty.call(a,b)){var c=a[b];"object"==typeof c?X[b]=V(X,b,[]).concat(c):V(X,b,c)}if(b=a.u)a=V(X,"us",[]),a.push(b),(b=/^https:(.*)$/.exec(b))&&a.push("http:"+b[1])}]);
var Gi=/^(\/[a-zA-Z0-9_\-]+)+$/,Hi=/^[a-zA-Z0-9\-_\.,!]+$/,Ii=/^gapi\.loaded_[0-9]+$/,Ji=/^[a-zA-Z0-9,._-]+$/;function Ki(a,b,c,d){var e=a.split(";"),f=e.shift(),g=Di[f],l=null;g?l=g(e,b,c,d):Fi("no hint processor for: "+f);l||Fi("failed to generate load url");b=l;c=b.match(Li);(d=b.match(Mi))&&1===d.length&&Ni.test(b)&&c&&1===c.length||Fi("failed sanity: "+a);return l}
...
Di.m=function(a,b,c,d){(a=a[0])||Fi("missing_hint");return"https://apis.google.com"+Oi(a,b,c,d)};
var Ti=decodeURI("%73cript"),Ui=/^[-+_0-9\/A-Za-z]+={0,2}$/;function Vi(a,b){for(var c=[],d=0;d<a.length;++d){var e=a[d];e&&0>ti.call(b,e)&&c.push(e)}return c}
...
c=f&&d&&e?[e,jj(hj(f),d,c||null)].join(" "):null;break a}c=null}c&&(b.headers.Authorization=c,b.headers["X-Goog-AuthUser"]=F("SESSION_INDEX",0));bd("//"+this.b.Vb+("/youtubei/"+this.b.innertubeApiVersion+"/"+a)+"?alt=json&key="+this.b.innertubeApiKey,b)};function Ne(){return M("enable_youtubei_innertube")?lj:dj}
...
(function(){if(ve)return Vj(/Firefox\/([0-9.]+)/);if(H||sc||rc)return Bc;if(ze)return Vj(/Chrome\/([0-9.]+)/);if(Ae&&!(nc()||B("iPad")||B("iPod")))return Vj(/Version\/([0-9.]+)/);if(we||xe){var a=/Version\/(\S+).*Mobile\/(\S+)/.exec(A);if(a)return a[1]+"."+a[2]}else if(ye)return(a=Vj(/Android\s+([0-9.]+)/))?a:Vj(/Version\/([0-9.]+)/);return""})();function Wj(a){Xj();this.enabled=Math.random()<a;this.events=[]}
var Xj=n.performance&&n.performance.now?w(n.performance.now,n.performance):x;function Yj(a){Wj.call(this,a)}
y(Yj,Wj);new Yj(1E-4);var Zj=(new Date).getTime();function ak(){var a=Qa(bk);return new N(function(b,c){a.F=function(a){Yc(a)?b(a):c(new ck("Request failed, status="+a.status,"net.badstatus"))};
a.onError=function(){c(new ck("Unknown request error","net.unknown"))};
a.R=function(){c(new ck("Request timed out","net.timeout"))};
cd("//googleads.g.doubleclick.net/pagead/id",a)})}
function ck(a,b){pa.call(this,a+", errorCode="+b);this.errorCode=b}
y(ck,pa);ck.prototype.name="PromiseAjaxError";function dk(a){pa.call(this,a.message||a.description||a.name);this.b=a instanceof Uf}
y(dk,pa);dk.prototype.name="BiscottiError";function ek(a,b){this.f=a;this.b=b}
ek.prototype.then=function(a,b,c){try{if(p(this.f))return a?Rf(a.call(c,this.f)):Rf(this.f);if(p(this.b)){if(!b)return Sf(this.b);var d=b.call(c,this.b);return!p(d)&&this.b.b?Sf(this.b):Rf(d)}throw Error("Invalid Result_ state");}catch(e){return Sf(e)}};
Mf(ek);var bk={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},fk=null;function gk(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))return hk(""),fk=new ek(""),"";a=JSON.parse(a.substr(4)).id;hk(a);fk=new ek(a);ik(18E5,2);return a}
function jk(a,b){b=new dk(b);hk("");fk=new ek(void 0,b);0<a&&ik(12E4,a-1);throw b;}
function ik(a,b){G(function(){var a=w(jk,n,b),a=ak().then(gk,a);Tf(a,null,t,void 0)},a)}
function hk(a){q("yt.www.ads.biscotti.lastId_",a,void 0)}
;function kk(){}
function lk(){try{var a;try{var b=r("yt.www.ads.biscotti.getId_"),c;if(b)c=b();else{if(!fk){var d=w(jk,n,2);fk=ak().then(gk,d)}c=fk}a=c}catch(e){a=Sf(e)}a.then(mk,kk);G(lk,18E5)}catch(e){Jb(e)}}
function mk(a){var b;a:{try{b=window.top.location.href}catch(u){b=2;break a}b=null!=b?b==window.document.location.href?0:1:2}b={dt:Zj,flash:Uj||"0",frm:b};b.u_tz=-(new Date).getTimezoneOffset();var c;try{c=Y.history.length}catch(u){c=0}b.u_his=c;b.u_java=!!Y.navigator&&"unknown"!==typeof Y.navigator.javaEnabled&&!!Y.navigator.javaEnabled&&Y.navigator.javaEnabled();Y.screen&&(b.u_h=Y.screen.height,b.u_w=Y.screen.width,b.u_ah=Y.screen.availHeight,b.u_aw=Y.screen.availWidth,b.u_cd=Y.screen.colorDepth);
Y.navigator&&Y.navigator.plugins&&(b.u_nplug=Y.navigator.plugins.length);Y.navigator&&Y.navigator.mimeTypes&&(b.u_nmime=Y.navigator.mimeTypes.length);b.bid=a;b.ca_type=Tj?"flash":"image";if(M("enable_server_side_search_pyv")||M("enable_server_side_mweb_search_pyv")){var d;a=window;try{d=a.screenX;var e=a.screenY}catch(u){}try{var f=a.outerWidth,g=a.outerHeight}catch(u){}try{var l=a.innerWidth,h=a.innerHeight}catch(u){}d=[a.screenLeft,a.screenTop,d,e,a.screen?a.screen.availWidth:void 0,a.screen?a.screen.availTop:
void 0,f,g,l,h];var m;e=window.top||Y;try{m=e.document&&!e.document.body?new pd(-1,-1):Id(e||window).round()}catch(u){m=new pd(-12245933,-12245933)}e=0;window.SVGElement&&document.createElementNS&&(e|=1);oa(b,{bc:e,bih:m.height,biw:m.width,brdim:d.join(),vis:{visible:1,hidden:2,prerender:3,preview:4}[Pj.webkitVisibilityState||Pj.mozVisibilityState||Pj.visibilityState||""]||0,wgl:!!Y.WebGLRenderingContext})}bd("/ad_data_204",{sb:!0,C:b})}
;function nk(){this.b=F("ALT_PREF_COOKIE_NAME","PREF");var a;if(a=Ue.get(""+this.b,void 0)){a=unescape(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Z[d]=c.toString())}}}
ba(nk);var Z=r("yt.prefs.UserPrefs.prefs_")||{};q("yt.prefs.UserPrefs.prefs_",Z,void 0);function ok(a){if(/^f([1-9][0-9]*)$/.test(a))throw"ExpectedRegexMatch: "+a;}
function pk(a){if(!/^\w+$/.test(a))throw"ExpectedRegexMismatch: "+a;}
function qk(a){a=void 0!==Z[a]?Z[a].toString():null;return null!=a&&/^[A-Fa-f0-9]+$/.test(a)?parseInt(a,16):null}
nk.prototype.get=function(a,b){pk(a);ok(a);a=void 0!==Z[a]?Z[a].toString():null;return null!=a?a:b?b:""};
nk.prototype.set=function(a,b){pk(a);ok(a);if(null==b)throw"ExpectedNotNull";Z[a]=b.toString()};
nk.prototype.remove=function(a){pk(a);ok(a);delete Z[a]};
nk.prototype.clear=function(){Z={}};function rk(a){for(var b=0;b<a.length;b++){var c=a[b];"send_follow_on_ping_action"==c.name&&c.data&&c.data.follow_on_url&&(c=c.data.follow_on_url)&&mg(c)}}
;function sk(a){O.call(this,1,arguments);this.pa=a}
y(sk,O);function tk(a,b){O.call(this,2,arguments);this.f=a;this.b=b}
y(tk,O);function uk(a,b,c,d){O.call(this,1,arguments);this.b=b;this.f=c||null;this.itemId=d||null}
y(uk,O);function vk(a,b){O.call(this,1,arguments);this.f=a;this.b=b||null}
y(vk,O);function wk(a){O.call(this,1,arguments)}
y(wk,O);var xk=new P("ypc-core-load",sk),yk=new P("ypc-guide-sync-success",tk),zk=new P("ypc-purchase-success",uk),Ak=new P("ypc-subscription-cancel",wk),Bk=new P("ypc-subscription-cancel-success",vk),Ck=new P("ypc-init-subscription",wk);var Dk=!1,Ek=[],Fk=[];function Gk(a){a.b?Dk?Q(Ch,a):Q(xk,new sk(function(){Q(Ck,new wk(a.b))})):Hk(a.f,a.i,a.g,a.source)}
function Ik(a){a.b?Dk?Q(Hh,a):Q(xk,new sk(function(){Q(Ak,new wk(a.b))})):Jk(a.f,a.subscriptionId,a.i,a.g,a.source)}
function Kk(a){Lk(Ea(a.b))}
function Mk(a){Nk(Ea(a.b))}
function Ok(a){Pk(a.g,a.f,a.b)}
function Qk(a){var b=a.itemId,c=a.b.subscriptionId;b&&c&&Q(Bh,new uh(b,c,a.b.channelInfo))}
function Rk(a){var b=a.b;Ka(a.f,function(a,d){Q(Bh,new uh(d,a,b[d]))})}
function Sk(a){Q(Gh,new S(a.f.itemId));a.b&&a.b.length&&(Tk(a.b,Gh),Tk(a.b,Ih))}
function Hk(a,b,c,d){var e=new S(a);Q(zh,e);var f={};f.c=a;c&&(f.eurl=c);d&&(f.source=d);c={};(d=F("PLAYBACK_ID"))&&(c.plid=d);(d=F("EVENT_ID"))&&(c.ei=d);b&&Uk(b,c);cd("/subscription_ajax?action_create_subscription_to_channel=1",{method:"POST",wa:f,C:c,F:function(b,c){b=c.response;Q(Bh,new uh(a,b.id,b.channel_info));b.show_feed_privacy_dialog&&Ub("SHOW-FEED-PRIVACY-SUBSCRIBE-DIALOG",a);b.actions&&rk(b.actions)},
va:function(){Q(Ah,e)}})}
function Jk(a,b,c,d,e){var f=new S(a);Q(Eh,f);var g={};d&&(g.eurl=d);e&&(g.source=e);d={};d.c=a;d.s=b;(a=F("PLAYBACK_ID"))&&(d.plid=a);(a=F("EVENT_ID"))&&(d.ei=a);c&&Uk(c,d);cd("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",wa:g,C:d,F:function(a,b){a=b.response;Q(Gh,f);a.actions&&rk(a.actions)},
va:function(){Q(Fh,f)}})}
function Pk(a,b,c){if(a){var d={};d.channel_id=a;switch(b){case "receive-all-updates":d.receive_all_updates=!0;break;case "receive-no-updates":d.receive_no_updates=!0;d.receive_post_updates=!1;break;case "receive-highlight-updates":d.receive_all_updates=!1;d.receive_no_updates=!1;break;default:return}null===c||d.receive_no_updates||(d.receive_post_updates=c);var e=new sh(a,b,c);cd("/subscription_ajax?action_update_subscription_preferences=1",{method:"POST",C:d,onError:function(){Q(Mh,e)},
F:function(){Q(Lh,e)}})}}
function Lk(a){if(a.length){var b=Ga(a,0,40);Q("subscription-batch-subscribe-loading");Tk(b,zh);var c={};c.a=b.join(",");var d=function(){Q("subscription-batch-subscribe-loaded");Tk(b,Ah)};
...
a.length?Lk(a):Q("subscription-batch-subscribe-finished")}},
onError:function(){d();Q("subscription-batch-subscribe-failure")}})}}
function Nk(a){if(a.length){var b=Ga(a,0,40);Q("subscription-batch-unsubscribe-loading");Tk(b,Eh);var c={};c.c=b.join(",");var d=function(){Q("subscription-batch-unsubscribe-loaded");Tk(b,Fh)};
cd("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",C:c,F:function(){d();Tk(b,Gh);a.length&&Nk(a)},
onError:function(){d()}})}}
function Tk(a,b){z(a,function(a){Q(b,new S(a))})}
function Uk(a,b){a=Vc(a);oa(b,a)}
;var Vk=null,Wk=null,Xk=null,Yk={};function Zk(a){var b=a.id;a=a.ve_type;var c=Ce++;a=new Be(void 0,a,c);Yk[b]=a;b=Re();c=Qe();b&&c&&Le(b,c,a)}
function $k(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(Fb("client-screen-nonce",b),Fb("ROOT_VE_TYPE",a),a=Qe()))for(var c in Yk)Le(b,a,Yk[c])}
function al(a){Yk[a.id]=new Be(a.tracking_params)}
function bl(a){var b=Re();a=Yk[a.id];b&&a&&Me(Ne(),{click:{csn:b,visualElement:De(a)}},void 0)}
function cl(a){a=a.ids;var b=Re();if(b){for(var c=[],d=0;d<a.length;d++){var e=Yk[a[d]];e&&c.push(e)}c.length&&Oe(b,c)}}
function dl(){var a=Vk.startInteractionLogging;a&&a()}
...
q("writeEmbed",function(){var a=F("PLAYER_CONFIG",void 0);"1"!=a.privembed&&lk();"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=F("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);F("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");a.args.autoplay&&qj(a.args);Vk=b=fh("player",a);b.addEventListener("onScreenChanged",$k);b.addEventListener("onLogClientVeCreated",Zk);b.addEventListener("onLogServerVeCreated",al);b.addEventListener("onLogVeClicked",
bl);b.addEventListener("onLogVesShown",cl);b.addEventListener("onReady",dl);var d=F("POST_MESSAGE_ID","player");F("ENABLE_JS_API")?Xk=new Lj(b):F("ENABLE_POST_API")&&v(d)&&v(c)&&(Wk=new Oj(window.parent,d,c),Xk=new Dj(b,Wk.g));F("ENABLE_CAST_API")||(a.args.enablecastapi="0");F("BG_P")&&(F("BG_I")||F("BG_IU"))&&fc();nd();rj=b;rj.addEventListener("SUBSCRIBE",uj);rj.addEventListener("UNSUBSCRIBE",xj);sj.push(R(Bh,yj),R(Gh,zj))},void 0);
q("yt.www.watch.ads.restrictioncookie.spr",function(a){(a+="mac_204?action_fcts=1")&&mg(a);return!0},void 0);
var el=Hb(function(){Cg("ol");Dk=!0;Fk.push(R(yh,Gk),R(Dh,Ik));Dk||Fk.push(R(Ch,Gk),R(Hh,Ik),R(wh,Kk),R(xh,Mk),R(Kh,Ok),R(zk,Qk),R(Bk,Sk),R(yk,Rk));var a=nk.getInstance(),b=1<window.devicePixelRatio;if(!!((qk("f"+(Math.floor(119/31)+1))||0)&67108864)!=b){var c="f"+(Math.floor(119/31)+1),d=qk(c)||0,d=b?d|67108864:d&-67108865;0==d?delete Z[c]:Z[c]=d.toString(16).toString();var a=a.b,b=[],e;for(e in Z)b.push(e+"="+escape(Z[e]));Ue.set(""+a,b.join("&"),63072E3,"/","youtube.com")}}),fl=Hb(function(){var a=
Vk;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();F("PL_ATT")&&(ec=null);for(var a=0,b=ld.length;a<b;a++){var c=ld[a];if(!isNaN(c)){var d=r("yt.scheduler.instance.cancelJob");d?d(c):Ib(c)}}ld.length=0;a=ac("//static.doubleclick.net/instream/ad_status.js");if(b=document.getElementById(a))Wb(a),b.parentNode.removeChild(b);md=!1;Fb("DCLKSTAT",0);Tb(Ek);Ek.length=0;ug(Fk);Fk.length=0;Dk=!1;rj&&(rj.removeEventListener("SUBSCRIBE",vj),rj.removeEventListener("UNSUBSCRIBE",xj));rj=null;ug(sj);sj.length=0;
Bb(Xk,Wk);if(a=Vk)a.removeEventListener("onScreenChanged",$k),a.removeEventListener("onLogClientVeCreated",Zk),a.removeEventListener("onLogServerVeCreated",al),a.removeEventListener("onLogVeClicked",bl),a.removeEventListener("onLogVesShown",cl),a.removeEventListener("onReady",dl),a.destroy();Yk={}});
window.addEventListener?(window.addEventListener("load",el),window.addEventListener("unload",fl)):window.attachEvent&&(window.attachEvent("onload",el),window.attachEvent("onunload",fl));var gl=ii.getInstance(),hl=U(gl);hl in ni||(gl.register(),gl.ja.push(Rb("yt-uix-init-"+hl,gl.init,gl)),gl.ja.push(Rb("yt-uix-dispose-"+hl,gl.dispose,gl)),ni[hl]=gl);})();
